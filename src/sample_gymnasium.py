...
class GymnasiumTraining:
    ...
    def __init__(self, 
                 envName: str, envWrapper: Wrapper | None = None, actions: list | None = None,
                 network: Callable[[int], NeuralNetwork] | None = None, resumePath: str | None = None, savePath: str | None = None,
                 ) -> None:
        pass
